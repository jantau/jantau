...
Der [Dax 30 hat ein Allzeithoch](https://www.faz.net/aktuell/finanzen/dax-mit-naechstem-rekord-17233800.html) erreicht. Und die Frage kommt auf: Ist das gut oder schlecht? Soll ich jetzt noch kaufen oder ist der Kurs zu hoch? Diese Frage wurde schon oft gestellt und [die](https://www.youtube.com/watch?v=y728UY7kwqk) grundsätzliche [Antwort](https://ofdollarsanddata.com/should-you-buy-an-all-time-high/) lautet [ja](https://fourpillarfreedom.com/should-you-invest-when-the-stock-market-is-at-an-all-time-high/). Das Timing des Marktes ist nicht möglich und das Warten auf niedrigere Kurse ist mit Opportunitätskosten verbunden, die bei einem weitem Anlagehorizont statistisch betrachtet höher sind als ein direkter Einstieg. 
...
Die Analyse zeigt: Es ist nicht wahnsinnig selten, dass ein Allzeithoch erreicht wird. 
...
Seit dem Jahr 2016 befinden sich nun sowohl der NASDAQ 100 als auch der S&P 500 TR in einer Phase, die relativ kontinuierlich mit nur kürzeren Unterbrechungen Allzeithochs aufweist.
...
Ich kann in den Allzeithochs kein Muster erkennen. Es kann lange Phasen geben von über 10 Jahren geben, in denen kontinuierliche neue Allzeithochs erreicht werden. Diese können von Phasen abgelöst werden, in denen 15 Jahre lang nicht an die vergangenen Höchststände angeschlossen werden kann. Für Investoren mit schwachen Nerven ist sicherlich der S&P 500 TR eine gute Wahl, dieser Index hat im Untersuchungszeitraum 1990 bis heute ziemlich kontinuierlich neue Höchstwerte erzielt und weist mit sechs Jahren (genau 2243 Tage vom 1.9.2000 bis 23.10.2006) die kürzeste Durststrecke auf. 
...
Die letzten Grafiken zeigen: In aller Regel bietet sich nach einem Allzeithoch schon die Gelegenheit, zu einem günstigeren Kurs in den Index einzusteigen. Ob sich das Abwarten auf günstigere Kurse bei einem langfristigen Anlagehorizont tatsächlich lohnt oder ob ein geringfügig niedrigerer Kurs langfristig nicht ins Gewicht fällt, ist sicherlich eine andere Frage.
