...
Je erfolgreicher ein ETF, desto größer sind auch die Unterschiede zwischen dem besten und dem schlechtesten Anlagetag. Da die erfolgreichen ETFs relativ kontinuierlich steigen, ist es umso effektiver, frühzeitig investiert zu sein, auch wenn es sich bei einer monatlichen Einlage nur um einige Wochen oder Tagen Unterschied handelt. 
...
So früh wie möglich im Monat zu investieren ergibt also absolut Sinn, insbesondere, wenn so vermieden wird, dass der Anlagebetrag mehrere Wochen uninvestiert auf dem Depotkonto liegt. Falls der Sparplan einen flexiblen bzw. frühen Anlagetag jedoch nicht hergibt, würde ich vermutlich nach wie vor nicht alles umstellen, um über den perfekten Anlagetag die letzten Prozente herauszuholen — obwohl ich bei meinem suboptimalen Ausführungstag über [maxblue](https://www.maxblue.de/geldanlage/geld-anlegen/wertpapiersparplan.html) (der 20. jeden Monats) langsam ins Grübeln kommen.
